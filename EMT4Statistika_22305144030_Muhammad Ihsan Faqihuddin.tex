...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-002.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-003.png}
\begin{eulercomment}
Contoh soal rata-rata dan standar deviasi:

Diketahui ada beberapa data yang tersebar terdiri dari
47,42,39,45,40,32,35. Tentukan berapakah rata-rata dan standar
deviasinya!

Pembahasan:

Untuk menghitung standar deviasi, pertama-tama dihitung terleih dahulu
nilai mean atau rata-rata dari data tersebut.

\end{eulercomment}
\begin{eulerformula}
\[
\bar{x}=\frac{\sum_{i=1}^{n}x_i}{n}=\frac{47+42+39+45+40+32+35}{7}=\frac{280}{7}=40
\]
\end{eulerformula}
\begin{eulercomment}
Sehingga rata-rata dari data di atas adalah 40. Selanjutnya menghitung
standar deviansi dan varians. Standar deviasi merupakan akar dari
besar varians sehingga pertama-tama bisa dihitung nilai varians dari
sebaran data di atas menggunakan rumus berikut:

\end{eulercomment}
\begin{eulerformula}
\[
S^2=\frac{(x_i-\bar{x})^2}{n-1}=\frac{(47-40)^2+(42-40)^2+(39-40)^2+(45-40)^2+(40-40)^2+(32-40)^2+(35-40)^2}{7-1}
\]
\end{eulerformula}
\begin{eulerformula}
\[
S^2=\frac{(7)^2+(2)^2+(-1)^2+(5)^2+(0)^2+(-8)^2+(-5)^2}{6}=\frac{49+4+1+25+0+64+25}{6}=\frac{168}{6}=28
\]
\end{eulerformula}
\begin{eulercomment}
Selanjutnya dihitung standar deviasi data tersebar di atas dengan
mengakarkan nilai varians.
...
\end{eulerformula}
\begin{eulerprompt}
>data=[47,42,39,45,40,32,35]
\end{eulerprompt}
\begin{euleroutput}
  [47,  42,  39,  45,  40,  32,  35]
\end{euleroutput}
\begin{eulerprompt}
>mean(data), dev(data)
\end{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Misalkan data tersebut adalah data ukuran sepatu 7 mahasiswa kelas Mat
B 2022 yang dipilih acak, berapakah persentase mahasiswa kelas Mat B
2022 yang memiliki sepatu dengan ukuran lebih dari atau sama dengan
45? 
\end{eulercomment}
\begin{eulerprompt}
>1-normaldis(45,40,5.2915)
\end{eulerprompt}
\begin{euleroutput}
  0.172351991469
\end{euleroutput}
...
Pendataan nilai ulangan matematika dilakukan pada 40 siswa. Data nilai
tersebut dikelompokkan dalam bentuk kelas-kelas interval dimulai dari
nilai 52-100.

Data nilai tersebut dibuat dengan rentng antara lain
52-58,59-65,66-72,73-79,80-86,67-93,94-100 dengan masing-masing
frekuensi yaitu 7,8,6,5,7,3, dan 3.

Pembahasan:

Ada beberapa langkah yang dapat dilakukan untuk mencari rataan hitung
pada data kelompok, yaitu:
...
\begin{eulerformula}
\[
\sum f_i=6+8+9+5+7+3+2+40
\]
\end{eulerformula}
\begin{eulercomment}
Sehingga diperoleh jumlah sebanyak 40.

3. Setelah itu, mengalikan nilai titik tengah (xi) dengan frekuensi
(fi) pada masing-masing kelas interval.

Nilai 52-58, fi*xi=6*55=110\\
Nilai 59-65, fi*xi=8*62=496\\
Nilai 66-72, fi*xi=9*69=621\\
Nilai 73-79, fi*xi=5*76=380\\
Nilai 80-86, fi*xi=7*83=681\\
Nilai 87-93, fi*xi=3*90=270\\
Nilai 94-100, fi*xi=2*97=194

4. Kemudian menjumlahkan hasil perkalian antara nilai titik tengah
(xi) dengan frekuensi (fi) pada semua kelas interval.

\end{eulercomment}
\begin{eulerformula}
\[
\sum f_i \cdot x_1=110+496+621+380+581+270+194=2652
\]
\end{eulerformula}
\begin{eulercomment}
5. Raaan hitung (mean) data kelompok dapat dihitung menggunakan rumus:

\end{eulercomment}
\begin{eulerformula}
\[
\bar{x}=\frac{\sum f_i \cdot x_i}{\sum f_i}=\frac{2652}{40}=66.3
\]
\end{eulerformula}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-004.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-005.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-009.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-010.png}
\begin{eulercomment}
...
\begin{euleroutput}
  ...
  0.527633447259
\end{euleroutput}
\eulerheading{Distriusi Diskrit}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-011.png}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
Selain itu, invbinsum() menghitung kebalikan dari binomialsum().
\end{eulercomment}
\begin{eulerprompt}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-012.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-014.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-015.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-016.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-017.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-020.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-023.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-027.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-031.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-032.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-033.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-034.png}
\begin{eulercomment}
Hapus data.
\end{eulercomment}
\begin{eulerprompt}
...
tetapi perlu mengetahui perbedaan sintaks EMT dan\\
R. Kami mencoba memberikan gambaran umum tentang hal-hal yang jelas
dan kurang jelas yang perlu Anda ketahui. 
...
mengalami ambiguitas yang sama di EMT, tetapi mencoba untuk
menghilangkannya.
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-037.png}
\eulerheading{List (Daftar)}
\begin{eulercomment}
...
Semua koma digantikan oleh titik-titik dengan parameter \textgreater{}comma. Untuk
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika_22305144030_Muhammad Ihsan Faqihuddin-038.png}
\begin{eulercomment}
...
Dalam contoh ini, kita membaca versi saat ini dari situs EMT. Kami
menggunakan ekspresi reguler untuk memindai "Versi\\
..." dalam sebuah judul.
\end{eulercomment}
\begin{eulerprompt}
...
\begin{euleroutput}
  Version 2022-05-18
\end{euleroutput}
\eulerheading{Memasukkan dan Mengeluarkan Variabel}
\begin{eulercomment}
