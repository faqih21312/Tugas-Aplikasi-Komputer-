...
>C=[2,2]; plotPoint(C,"C"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-001.png}
\begin{eulercomment}
Then three segments.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-002.png}
\begin{eulercomment}
The geometry functions include functions to create lines and circles.
The format for the line is [a,b,c], which represents the line with
equation ax+by=c.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-004.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-005.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-007.png}
...
\begin{eulercomment}
1. Mencari titik singgung lingkaran dalam dengan sisi-sisi segitiga
ABC.
\end{eulercomment}
\begin{eulerprompt}
>c=circleWithCenter(P,r)
\end{eulerprompt}
\begin{euleroutput}
  [0.86038,  0.86038,  0.509654]
\end{euleroutput}
\begin{eulerprompt}
>L=lineCircleIntersections(lineThrough(A,B),c)
\end{eulerprompt}
\begin{euleroutput}
  [0.5,  0.5]
\end{euleroutput}
\begin{eulerprompt}
>M=lineCircleIntersections(lineThrough(B,C),c)
\end{eulerprompt}
\begin{euleroutput}
  [0.632456,  1.31623]
\end{euleroutput}
\begin{eulerprompt}
>N=lineCircleIntersections(lineThrough(C,A),c)
\end{eulerprompt}
\begin{euleroutput}
  [1.31623,  0.632456]
\end{euleroutput}
\begin{eulerprompt}
>plotPoint(L); plotPoint(M); plotPoint(N):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-008.png}
\begin{eulercomment}
2. Menggambar segitiga yang melalui titik singgung lingkaran dalam
segitiga ABC
\end{eulercomment}
\begin{eulerprompt}
>plotSegment(L,M); plotSegment(M,N); plotSegment(N,L):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-009.png}
\begin{eulerprompt}
>degprint(computeAngle(L,M,N)), degprint(computeAngle(M,N,L)), degprint(computeAngle(N,L,M))
\end{eulerprompt}
\begin{euleroutput}
  54°13'2.91''
  54°13'2.91''
...
\end{euleroutput}
\begin{eulercomment}
3. Menghitung luas segitiga LMN
\end{eulercomment}
\begin{eulerprompt}
>areaTriangle(L,M,N)
\end{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
4. Akan ditunjukkan garis bagi sudut yang ketiga, yaitu sudut ABC juga
melalui pusat lingkaran dalam.
\end{eulercomment}
\begin{eulerprompt}
>color(5); i=angleBisector(A,B,C); plotLine(i); color(1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-010.png}
\begin{eulercomment}
Terlihat pada gambar bahwa garis bagi sudut ABC, melalui pusat
lingkaran dalam segitiga ABC.

5. Menggambar jari-jari lingkaran dalam 
\end{eulercomment}
\begin{eulerprompt}
>plotSegment(P,N, "r"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-011.png}
\begin{eulercomment}
6. Adakah hubungan antara luas kedua lingkaran tersebut dengan luas
segitiga ABC?
\end{eulercomment}
\begin{eulerprompt}
>R, r
...
\end{euleroutput}
\begin{eulerprompt}
>luasLingkaranLuar=pi*R^2
\end{eulerprompt}
\begin{euleroutput}
  4.36332312999
\end{euleroutput}
\begin{eulerprompt}
>luasLingkaranDalam=pi*r^2
\end{eulerprompt}
\begin{euleroutput}
  0.81601903655
\end{euleroutput}
\begin{eulerprompt}
>a=distance(A,B); b=distance(B,C); c=distance(C,A);
>R, a*b*c/4/areaTriangle(A,B,C)
\end{eulerprompt}
\begin{euleroutput}
  1.17851130198
  1.17851130198
...
\end{euleroutput}
\begin{eulercomment}
Ada hubungan antara luas lingkaran luar dan dalam segitiga, yaitu

\end{eulercomment}
\begin{eulerformula}
\[
R=\frac{abc}{4\cdot \text{Luas segitiga}}, r=\frac{2\cdot \text{Luas segitga}}{a+b+c}
\]
\end{eulerformula}
\begin{eulercomment}
ini mengakibatkan\\
...
\begin{eulerformula}
\[
\frac{\text{Luas lingkaran luar}}{\text{Luas lingkaran dalam}}=\frac{\pi R^2}{\pi r^2}=\frac{R^2}{r^2}=\frac{(\frac{abc}{(4\cdot \text{Luas segitiga}})^2}{(\frac{2\cdot \text{Luas segitga}}{a+b+c})^2}
\]
\end{eulerformula}
\begin{eulerformula}
\[
=\frac{a^2b^2c^2}{16 \cdot(\text {Luas segitiga})^2}\cdot \frac{(a+b+c)^2}{4 \cdot (\text{Luas segitiga})^2}=\frac{a^2b^2c^2(a+b+c)^2}{64 \cdot (\text {Luas segitga})^4}
\]
\end{eulerformula}
\begin{eulerprompt}
>rasio=a^2*b^2*c^2*(a+b+c)^2/64/(areaTriangle(A,B,C))^4
\end{eulerprompt}
\begin{euleroutput}
  5.34708497541
\end{euleroutput}
\begin{eulerprompt}
>luasLingkaranLuar, rasio*luasLingkaranDalam    
\end{eulerprompt}
\begin{euleroutput}
  4.36332312999
  4.36332312999
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-013-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-015-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-021-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-025.png}
\begin{eulercomment}
The same in Maxima.
\end{eulercomment}
\begin{eulerprompt}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-027.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{eulercomment}
Persamaannya cukup rumit. Tetapi kita dapat menyederhanakannya, jika
kita menyelesaikan untuk y.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-032.png}
\begin{eulerprompt}
...
\begin{euleroutput}
  ...
  Error in:
  H(3,4,5) // luas segitiga siku-siku dengan panjang sisi 3, 4,  ...
          ^
\end{euleroutput}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-036-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-037.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-042-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-045.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
For the Hesse form, we need to specify a point, such that the point is
on the positive side of the Hesseform. Inserting the point yields the
positive distance to the line.
\end{eulercomment}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-049-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-052.png}
\begin{eulercomment}
We can compute the intersection of the heights in ABC (the
orthocenter) numerically with the following command.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-055.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-062.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-064.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-065.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-068-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-071-large.png}
\begin{eulercomment}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-072.png}
\begin{eulercomment}
Tentu saja,
...
\end{euleroutput}
\begin{eulercomment}
Aturan kosinus trgonometri klasik diterjemahkan ke dalam "aturan
silang" berikut ini.
...
turan-aturan ini diimplementasikan dalam file geometri.e yang kita
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-077-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-081.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-084-large.png}
\eulerimg{0}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-085-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-088-large.png}
\begin{eulercomment}
...
Harus diakui, hal ini sulit dilakukan dengan pensil dan kertas.
\end{eulercomment}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-096-large.png}
\eulersubheading{Aturan Spread Tiga Kali Lipat}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-100-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-102.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-104-large.png}
\eulerimg{1}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-105-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-107.png}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulercomment}
Mari kita periksa rumus ini untuk nilai-nilai Mesir.
\end{eulercomment}
\begin{eulerprompt}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-110.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-114.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-115.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-116.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-117.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-118.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-119.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-120.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-121.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-123.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-124.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-125.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-126.png}
...
Kita menggunakan file geometry.e dari Euler untuk hal ini.
\end{eulercomment}
\begin{eulerprompt}
>load geometry;
\end{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Kita sudah memplot semuanya sejauh ini.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-127.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-131.png}
...
>povend();
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-132.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-133.png}
...
\end{euleroutput}
\begin{eulercomment}
Kita tulis sebuah fungsi, yang memplot bumi, dua posisi, dan posisi di
antaranya.
\end{eulercomment}
\begin{eulerprompt}
>function testplot ...
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-134.png}
\begin{eulercomment}
Atau gunakan plot3d untuk mendapatkan tampilan anaglyph. Ini terlihat
sangat bagus dengan kacamata merah/cyan.
\end{eulercomment}
\begin{eulerprompt}
>ot3d("testplot",angle=25,height=6,distance=5,own=1,anaglyph=1,zoom=4):
\end{eulerprompt}
\begin{euleroutput}
  Function ot3d not found.
  Try list ... to find functions!
  Error in:
  ... e=25,height=6,distance=5,own=1,anaglyph=1,zoom=4): ...
                                                       ^
\end{euleroutput}
...
\begin{eulercomment}
Gambarlah parabola yang melalui titik (-1,10),(1,0),(2,1)\\
Penyelesaian:\\
Subtitusi koordinat titik-titik ke persamaan y=ax\textasciicircum{}2+bx+c\\
...
\end{eulerformula}
\begin{eulercomment}
Kemudian selesaikan SPL tersebut
\end{eulercomment}
\begin{eulerprompt}
>e$solve([a-b+c=10,a+b+c=0,4*a+2*b+c=1],[a,b,c])
\end{eulerprompt}
\begin{euleroutput}
...
\end{euleroutput}
\begin{eulercomment}
Jadi, persamaan parabola tersebut adalah y=2x\textasciicircum{}2-5x+3
\end{eulercomment}
\begin{eulerprompt}
> plot2d("2*x^2-5*x+3",-5,5,-5,15):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-135.png}
\begin{eulerprompt}
>plot2d([-1,1,2],[10,0,1],>add, >points, style="ow"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-136.png}
\eulersubheading{Soal 3}
\begin{eulercomment}
Gambarlah segi 4 yang titik-titik sudutnya adalah
(0,0),(2,0),(3,3),(0,2).
\end{eulercomment}
\begin{eulerprompt}
>setPlotRange(-1,4,-1,4);
>A=[0,0]; B=[2,0]; C=[3,3]; D=[0,2];
>plotPoint(A); plotPoint(B); plotPoint(C); plotPoint(D);
>plotSegment(A,B); plotSegment(B,C); plotSegment(C,D); plotSegment(D,A):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-137.png}
\begin{eulerprompt}
>l=angleBisector(D,A,B); m=angleBisector(A,B,C); n=angleBisector(B,C,D); o=angleBisector(C,D,A);
>plotLine(l,""); plotLine(m,""); plotLine(n,""); plotLine(o,""):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-138.png}
\begin{eulerprompt}
...
\end{euleroutput}
\begin{eulerprompt}
>c=circleWithCenter(p,p[1])
\end{eulerprompt}
\begin{euleroutput}
  [1.16228,  1.16228,  1.16228]
\end{euleroutput}
\begin{eulerprompt}
>plotCircle(c):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-139.png}
\eulersubheading{Soal 4}
\begin{eulercomment}
Gambarkan elips yang titik fokusnya di (6,0) dan (-6,0) dan panjang
sumbu mayornya adalah 10\\
Penyelesaian:\\
Titik fokus elips yang berpusat di (0,0) adalah (c,0) dan (-c,0)\\
Diketahui c=6, a=10, maka b\textasciicircum{}2=a\textasciicircum{}2-c\textasciicircum{}2=100-36=64\\
Jadi, persamaan elipsnya adalah\\
\end{eulercomment}
\begin{eulerformula}
\[
\frac{x^2}{a^2}+\frac{y^2}{b^2}=1 \Rightarrow \frac{x^2}{100}+\frac{y^2}{64}=1
\]
\end{eulerformula}
\begin{eulercomment}
bentuk persamaan parameter dari elips tersebut adalah\\
\end{eulercomment}
\begin{eulerformula}
\[
x=10\cos{t}
...
>x=10*cos(t); y=8*sin(t);
>plot2d(x,y,a=-10,b=10,c=-10,d=10):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-140.png}
\begin{eulerprompt}
>plot2d(6,0,>add,>points); ...
>plot2d(-6,0,>add,>points):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-141.png}
\eulersubheading{Soal 5}
\eulersubheading{}
\eulerheading{Contoh Soal Geometri}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{Soal 1}
\begin{eulercomment}
Tentukan persamaan lingkaran yang melalui titik (6,4), (5,5), dan
(5,-3)!\\
Penyelesaian:\\
Subtitusi titik-titik yang dilalui lingkaran ke persamaan
x\textasciicircum{}2+y\textasciicircum{}2+ax+by+c=0\\
...
\end{eulerformula}
\begin{eulercomment}
Selanjutnya, selesaikan SPL tersebut
\end{eulercomment}
\begin{eulerprompt}
>&solve([6*a+4*b+c=-52,5*a+5*b+c=-50,5*a-3*b+c=-34],[a,b,c])
\end{eulerprompt}
\begin{euleroutput}
...
\end{euleroutput}
\begin{eulercomment}
Jadi, persamaan lingkarannya adalah x\textasciicircum{}2+y\textasciicircum{}2-4x-2y-20=0

\end{eulercomment}
\eulersubheading{Soal 2}
\begin{eulercomment}
Tentukan persamaan garis yang melalui titik (1,2) dan (2,3)!
\end{eulercomment}
\begin{eulerprompt}
>setPlotRange(0,4,0,4):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-142.png}
\begin{eulerprompt}
>A=[1,2]; plotPoint(A); B=[2,3]; plotPoint(B):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-143.png}
\begin{eulerprompt}
>l=lineThrough(A,B); plotLine(l,""):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-144.png}
\begin{eulerprompt}
>$getLineEquation(l,x,y)
\end{eulerprompt}
\begin{eulerformula}
\[
y+x=3
...
\begin{eulerformula}
\[
\frac{y-y1}{y2-y1}=\frac{x-x1}{x2-x1} \Leftrightarrow \frac{y-2}{3-2}=\frac{x-1}{2-1} \Leftrightarrow y-2=x-1 \Leftrightarrow y=x+1
\]
\end{eulerformula}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{Soal 3}
\begin{eulercomment}
Tentukan persamaan garis singgung lingkaran x\textasciicircum{}2+y\textasciicircum{}2=180 yang
bergradien 2!\\
Penyelesaian:\\
rumus persamaan garis singgung lingkaran bergradien m yang berpusat di
O  adalah\\
\end{eulercomment}
\begin{eulerformula}
\[
...
\end{eulerformula}
\begin{eulercomment}
Jadi persamaan garis singgung lingkaran x\textasciicircum{}2+y\textasciicircum{}2=180 bergradien 2\\
\end{eulercomment}
\begin{eulerformula}
\[
y=2x \pm \sqrt{180} \sqrt{1+4}=2x \pm \sqrt{900}=2x \pm 30
\]
\end{eulerformula}
\begin{eulerformula}
\[
y=2x+30\text{  atau  } y=2x-30
\]
\end{eulerformula}
\begin{eulerprompt}
>t=linspace(0,2*pi,1000);
>x=6*sqrt(5)*cos(t); y=6*sqrt(5)*sin(t);
>plot2d(x,y,a=-20,b=20,c=-20,d=20):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-146.png}
\begin{eulerprompt}
>plot2d("2*x+30",>add); plot2d("2*x-30",>add):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry_22305144030_Muhammad Ihsan Faqihuddin-147.png}
\end{eulernotebook}
